...
<Tabs defaultValue="npm" className="pt-5 pb-1">
  ...
  <TabsContent value="npm">```bash npm i native-variants ```</TabsContent>
  <TabsContent value="yarn">```bash yarn add native-variants ```</TabsContent>
  <TabsContent value="pnpm">```bash pnpm i native-variants ```</TabsContent>
</Tabs>
